...
Besides being a crowd-pleaser at tailgates and game days, CHAD has several real world applications in the robotics industry.
...
George Wang: George is a CS major. He likes beer and Baxters. George wrote code for the gripper calibration and CHAD's trigger pull. He wrote most of this website and made the diagrams/visuals on this page.
...
We took 60fps videos like [this](https://youtu.be/7xTkK3VTanw) to figure out the initial velocity at which our ping pong ball leaves the gun barrel. This v_i was essential to CHAD's trajectory calculation and accurate shooting. 

We used the same projectile motion equation as mentioned above in the design section. Keeping the pitch angle at 0 degrees and height fixed, we measured distance traveled and time in the air (end frame - start frame).
...
## Code
Code for our [project.](https://github.com/chad-bot/CHADBot)
